...
public class Tela {
    ...
    private void criarCompetidores() {
        ...
        competidores.add(new Corredor("Pedro", 7));
        competidores.add(new Corredor("Igor", 6));
        competidores.add(new Corredor("Ferreira", 5));
        competidores.add(new Corredor("Martins", 4));
    ...
    private void iniciarCorrida() {
        ...
        if (distanciaDaCorrida > 0) {
            ...
            Thread visualizacao = new Thread(
                new Runnable(){
                    @Override
                    public void run() {
                        while(corridaOn()){
